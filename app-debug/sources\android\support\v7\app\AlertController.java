            ...
            if (spacer != null) {
                ...
                if (!hasTopPanel) {
                    ...
                    if (!(this.mMessage == null && this.mListView == null)) {
                        parentPanel = topPanel.findViewById(R.id.titleDividerNoCustom);
                    }
                    if (parentPanel != null) {
                        parentPanel.setVisibility(0);
                    }
                } else if (contentPanel != null) {
                    parentPanel = contentPanel.findViewById(R.id.textSpacerNoTitle);
                    if (parentPanel != null) {
                        indicators = 0;
                        parentPanel.setVisibility(0);
                        ...
                        if (!hasCustomPanel) {
                            parentPanel = this.mListView != null ? this.mListView : this.mScrollView;
                            if (parentPanel != null) {
                                int i = hasTopPanel ? 1 : indicators;
                                if (hasButtonPanel) {
                                    indicators = 2;
                                }
                                setScrollIndicators(contentPanel, parentPanel, i | indicators, 3);
