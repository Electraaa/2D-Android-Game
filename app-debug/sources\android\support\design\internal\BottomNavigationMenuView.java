...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mShiftingMode) {
            ...
            activeWidth = Math.min(width - (this.mInactiveItemMinWidth * inactiveCount), this.mActiveItemMaxWidth);
            ...
            for (activeWidth = 0; activeWidth < count; activeWidth++) {
                this.mTempChildWidths[activeWidth] = childWidth;
                if (extra2 > 0) {
        ...
        for (inactiveCount = 0; inactiveCount < count; inactiveCount++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(MeasureSpec.makeMeasureSpec(this.mTempChildWidths[inactiveCount], 1073741824), heightSpec);
