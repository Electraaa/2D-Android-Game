    ...
    public Animator createAnimator(@NonNull ViewGroup sceneRoot, @Nullable TransitionValues startValues, @Nullable TransitionValues endValues) {
        ...
        if (startParent == null) {
            ...
            if (parentMatches(startParent, endParent)) {
                ...
                if (numChanges > 0) {
                    ...
                    if (this.mResizeClip) {
                        ...
                        if (startClip3.equals(endClip3) == null) {
                            ...
                            i7 = endTop;
                            endTop = startParent;
                            AnonymousClass8 anonymousClass82 = new AnimatorListenerAdapter() {
                            ...
                            endParent.addListener(anonymousClass8);
                        } else {
                            endClip2 = endClip3;
                            rect = startClip3;
                            i8 = endWidth;
                ...
                startWidth = ((Integer) transitionValues4.values.get(PROPNAME_WINDOW_Y)).intValue();
                transitionValues3 = endValues;
                ...
                if (!(endTop == startParent && startWidth == endParent)) {
                    viewGroup = sceneRoot;
                    ...
                    PropertyValuesHolder origin = PropertyValuesHolderUtils.ofPointF(DRAWABLE_ORIGIN_PROPERTY, getPathMotion().getPath((float) (endTop - this.mTempLocation[0]), (float) (startWidth - this.mTempLocation[1]), (float) (startParent - this.mTempLocation[0]), (float) (endParent - this.mTempLocation[1])));
