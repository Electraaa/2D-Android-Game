...
public class AnimatorInflaterCompat {
    ...
    private static Animator createAnimatorFromXml(Context context, Resources res, Theme theme, XmlPullParser parser, AttributeSet attrs, AnimatorSet parent, int sequenceOrdering, float pixelSize) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            int type = next;
            Context context2;
            if (next != 3 || parser.getDepth() > depth2) {
                int i;
                if (type == 1) {
                    context2 = context;
                    i = depth2;
                    ...
                    if (name.equals("objectAnimator")) {
                        anim2 = loadObjectAnimator(context, resources, theme2, attrs, pixelSize, xmlPullParser);
                    } else if (name.equals("animator")) {
                        anim2 = loadAnimator(context, resources, theme2, attrs, null, pixelSize, xmlPullParser);
                    } else {
                        if (name.equals("set")) {
                            Animator anim3 = new AnimatorSet();
                            AttributeSet attributeSet = attrs;
                            TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme2, attributeSet, AndroidResources.STYLEABLE_ANIMATOR_SET);
                            ...
                            i = depth2;
                            depth2 = a;
                            createAnimatorFromXml(context3, resources2, theme3, xmlPullParser2, attributeSet2, (AnimatorSet) anim3, TypedArrayUtils.getNamedInt(a, xmlPullParser, "ordering", 0, 0), pixelSize);
                            depth2.recycle();
                            context2 = context;
                            anim = anim3;
                        } else {
