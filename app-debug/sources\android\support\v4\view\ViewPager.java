...
public class ViewPager extends ViewGroup {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:123:0x024e  */
            ...
            while (curIndex < this.mItems.size()) {
                ...
                if (ii.position >= this.mCurItem) {
                    ...
                    if (curItem == null) {
                        ...
                        float leftWidthNeeded = clientWidth <= 0 ? 0.0f : (((float) getPaddingLeft()) / ((float) clientWidth)) + (2.0f - curItem.widthFactor);
                        ...
                        while (pos >= 0) {
                            ...
                            if (extraWidthLeft < leftWidthNeeded || pos >= startPos) {
                                ...
                                if (ii2 == null || pos != ii2.position) {
                                    ...
                                    curIndex++;
                                    leftWidthNeeded = itemIndex >= 0 ? (ItemInfo) this.mItems.get(itemIndex) : null;
                                } else {
                                ...
                                leftWidthNeeded2 = leftWidthNeeded;
                                this.mAdapter.destroyItem(this, pos, ii2.object);
                                itemIndex--;
                                curIndex--;
                                leftWidthNeeded = itemIndex >= 0 ? (ItemInfo) this.mItems.get(itemIndex) : null;
                            }
                        ...
                        if (leftWidthNeeded < 2.0f) {
                            ii3 = pos < this.mItems.size() ? (ItemInfo) this.mItems.get(pos) : null;
                            float rightWidthNeeded = clientWidth <= 0 ? 0.0f : (((float) getPaddingRight()) / ((float) clientWidth)) + 2.0f;
                            int ii4 = this.mCurItem + 1;
                            while (ii4 < N) {
                                if (leftWidthNeeded < rightWidthNeeded || ii4 <= endPos) {
                                    pageLimit2 = pageLimit;
                                    startPos2 = startPos;
                                    if (ii3 == null || ii4 != ii3.position) {
                                        pageLimit = addNewItem(ii4, pos);
                                        pos++;
                                        leftWidthNeeded += pageLimit.widthFactor;
                                        ii3 = pos < this.mItems.size() ? (ItemInfo) this.mItems.get(pos) : null;
                                    } else {
                                        leftWidthNeeded += ii3.widthFactor;
                                        pos++;
                                        ii3 = pos < this.mItems.size() ? (ItemInfo) this.mItems.get(pos) : 0;
                                    }
                                } else if (ii3 == null) {
                                    pageLimit2 = pageLimit;
                                    startPos2 = startPos;
                                    ...
                                    pageLimit2 = pageLimit;
                                    if (ii4 == ii3.position && ii3.scrolling == 0) {
                                        this.mItems.remove(pos);
                                        startPos2 = startPos;
                                        this.mAdapter.destroyItem(this, ii4, ii3.object);
                                        ii3 = pos < this.mItems.size() ? (ItemInfo) this.mItems.get(pos) : 0;
                                    } else {
                                        startPos2 = startPos;
                                    }
                    ...
                    if (hasFocus()) {
                        ...
                        if (ii5 == null || ii5.position != this.mCurItem) {
                            ...
                            while (true) {
                                ...
                                View child2 = getChildAt(clientWidth);
