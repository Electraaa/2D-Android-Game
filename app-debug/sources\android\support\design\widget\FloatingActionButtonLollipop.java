...
class FloatingActionButtonLollipop extends FloatingActionButtonImpl {
    ...
    public void onElevationsChanged(float elevation, float pressedTranslationZ) {
        ...
        if (VERSION.SDK_INT != 21) {
            ...
            set.play(ObjectAnimator.ofFloat(this.mView, "elevation", new float[]{f}).setDuration(0)).with(ObjectAnimator.ofFloat(this.mView, View.TRANSLATION_Z, new float[]{f2}).setDuration(100));
            ...
            animators.add(ObjectAnimator.ofFloat(this.mView, "elevation", new float[]{f}).setDuration(0));
